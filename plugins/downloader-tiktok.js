...
let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  let bearr = 'hTtP44gE'
  let sayang = await fetch(`https://saipulanuar.ga/api/download/tiktok2?url=${args[0]}&apikey=${bearr}`)
